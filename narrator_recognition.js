...
function rankPropagation(nodes, edgesOfNodes, resultLevels, isCompiler) {
...
function processNarratorRecognition(nodes, edges) {
    const edgesOfNodes = [];
    for (let i = 0; i < nodes.length; i++) {
        edgesOfNodes.push({
            teachers: [],
    ...
    let [, finalResultLevels, classifiedLevels, maxDepth, resultDepth, maxTeacherLines] = rankPropagation(nodes, edgesOfNodes, resultLevels, isCompiler);
    ...
    let [, finalResultLevels2, classifiedLevels2, maxDepth2, resultDepth2, maxTeacherLines2] = rankPropagation(nodes, edgesOfNodes, resultLevels2, isCompiler);
